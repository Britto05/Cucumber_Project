...
public class CommonUtils {
	...
	public void initElements() {
	  ...
	  PageFactory.initElements(DriverManager.getDriver(), AllMenuLinks_Page_Objects.getInstance());
	  PageFactory.initElements(DriverManager.getDriver(), ReportLinks_Page_Objects.getInstnce());
