...
public class AllMenuLinks_Page_Objects {

	private static AllMenuLinks_Page_Objects AllMenuLinksInstance;
	
	private AllMenuLinks_Page_Objects(){
	}
	public static AllMenuLinks_Page_Objects getInstance() {
		
		if(AllMenuLinksInstance==null) {
			AllMenuLinksInstance = new AllMenuLinks_Page_Objects();
		}
