...
Scenario: Verify All Links in SALES REPORTS 
...
Scenario: Verify All Links in PRODUCTS REPORTS 
...
Scenario: Verify All Links in PURCHASE REPORTS  
...
Scenario: Verify All Links in GSTR REPORTS  
...
Scenario: Verify All Links in PURCHASE & SALES HISTORY REPORTS  
...
Scenario: Verify All Links in SUMMARY REPORTS  
...
Scenario: Verify TDS/TCS LEDGER REPORT 
 Given TDS Report Link Verified
 
Scenario: Verify BULK UPDATE REPORT
